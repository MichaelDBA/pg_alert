...
6. PG versions 9.6 and above
7. For non-remote clusters, PG Log file format must not extent to time, i.e., hours, minutes, seconds.
...
[PostgreSQL Error Codes](https://www.postgresql.org/docs/13/errcodes-appendix.html)
